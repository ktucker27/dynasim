...
public class MomentsCorrelationODEs implements DynaComplexODEs {
     ...
     */
    public MomentsCorrelationODEs(int n, double gamma, double w, DynaComplexCoupling coupling, double[] d, DynaComplex[] z) {
        super();
        this.n = n;
        this.gamma = gamma;
        this.w = w;
